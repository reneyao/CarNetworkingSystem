...
option = {
  ...
  /***  title: {
            ...
            xAxis : [
                {
                    ...
                    data: ['传智Model3系列','传智黑马系列 ','传智ModelS系列 ','传智ModelX系列','ITCAST_RUN系列','HEIMA_RUN系列','SUPER_CAR系列']
                }
            ],
            yAxis : {
				min:300,
    ...
    function echarts_5() {
        ...
        var xData = function() {
            var data = ['电池高温报警','单体电池过压报警','高压互锁状态报警','绝缘报警','单体电池一致性差'];

            return data;
        }();

        var data = [1123, 1002, 886, 752, 673]
        ...
        option = {
            ...
            tooltip: {
                show: "true",
                trigger: 'item',
                backgroundColor: 'rgba(96,207,87,0.4)', // 背景
                padding: [8, 10], //内边距
    ...
    function echarts_6() {
        ...
        for (var i = 0; i < data.chart.length; i++) {
            xAxisMonth.push(data.chart[i].series);
            barData.push({
                "name": xAxisMonth[i],
                ...
                itemStyle: {
                    normal: {
                        color: function(params) {
                            var colorList = [
                                'rgba(255,163,79,0.8)', 'rgba(96,207,87,0.6)',
                                'rgba(16,48,255,0.8)', 'rgba(255,69,91,0.6)',
                                'rgba(255,255,97,0.8)', 'rgba(133,24,182,0.6)',
                                'rgba(181,179,182,0.6)'
                            ];
