...
public class ItcastDataObj {
    ...
    //可充电储能子系统电压信息列表
    private String nevChargeSystemVoltageDtoList = "";    //nevChargeSystemVoltageDtoList里的信息 本帧电池起始序号
    ...
    // 扩展字段，用于存储异常数据   为后续区分正常数据和异常数据做准备
    ...
    public String toHiveString() {
        ...
        resultString.append("NULL").append("\t");    // nevChargeSystemVoltageDtoList  直接使用固定值null
        ...
        resultString.append("NULL").append("\t");    // driveMotorData  直接使用固定值null
        ...
        resultString.append("NULL").append("\t");    // nevChargeSystemTemperatureDtoList  直接使用固定值null
        ...
        // 注：hive建表最后是 :   vacBrkPRmu bigint,processTime string
        // 用当前时间填充处理时间
