...
import com.reneyao.realtime.utils.PhoenixJDBCUtil;
...
public class TestPhoenix {
    public static void main(String[] args) {
        try {
            // 正常连接
            // 创建库
//            PhoenixJDBCUtil.createSchema("CREATE SCHEMA IF NOT EXISTS BINGDATA");
            PhoenixJDBCUtil.setSchema("BINGDATA");
            // 创建表
            PhoenixJDBCUtil.create("CREATE TABLE user " +
                    "(id varchar PRIMARY KEY,name varchar ,passwd varchar)" );
            // 插入单条数据
