...
import com.reneyao.realtime.window.function.DstreamOperatorFlatMap;
import com.reneyao.realtime.window.function.DstreamOperatorMap;
...
public class TestDstreamOperatorTask {
    public static void main(String[] args) throws Exception {
        ...
        // 连接两个流并进行flatMap操作(了解与map操作的区别)   也就是说map操作的话，一条流对应一个操作，没有匹配到也会返回null，flatmap可以一对多，可以处理没有匹配到的
