package com.reneyao.realtime.base;


import com.reneyao.realtime.utils.FlinkSourceUtil;
...
// TODO : 展示不需要这个base，已经具备streaming 的流basetask
...
*/
        ...
        //3.1 声明消费的主题以及消费者组
        //3.2 创建消费者对象       flink消费者
        DataStreamSource kafkaSource = FlinkSourceUtil.getKafkaSource(topic, ckAndGroupId);
