...
/**
 * 实现驾驶行程数据结果入库，用作驾驶行程指标分析的数据源
 */
public class TripDivisionHBaseSink extends RichSinkFunction<TripModel> {
    //定义日志操作对象
    private final static Logger logger = LoggerFactory.getLogger(TripDivisionHBaseSink.class);
    //定义操作的hbase的表名
    ...
    public TripDivisionHBaseSink(String tableName){
