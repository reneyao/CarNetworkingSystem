...
public class SaveErrorDataHiveSink extends RichSinkFunction<ItcastDataObj> {
     ...
     * @param tableName
     */
    public SaveErrorDataHiveSink(String dataBaseName, String tableName) {
...
//        sb.append(DateUtil.getTodayDate());
     ...
     * @param stmt
     */
    private static void schemaAndTableExists(String databaseName, String tableName, Statement stmt) throws SQLException {
        // 如果数据库不存在，创建库
