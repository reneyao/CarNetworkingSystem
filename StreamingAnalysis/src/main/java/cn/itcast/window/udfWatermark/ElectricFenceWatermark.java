package cn.itcast.window.udfWatermark;

import cn.itcast.entity.ElectricFenceModel;
import org.apache.flink.streaming.api.functions.AssignerWithPeriodicWatermarks;
import org.apache.flink.streaming.api.watermark.Watermark;
import static cn.itcast.utils.DateUtil.dateToTimestamp;
...
//        currentMaxTimestamp = Math.max(element.getTerminalTimestamp(), currentMaxTimestamp);
        ...
        // "yyyy-MM-dd HH:mm:ss"
        long tempTime = dateToTimestamp(element.getTerminalTime(),"yyyy-MM-dd HH:mm:ss");
