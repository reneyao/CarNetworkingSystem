...
public class FlinkKafkaWriter {
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<String> source = env.readTextFile("C:\\Users\\104598\\Desktop\\Flink\\1-星途车联网系统第一章-项目基石与前瞻\\原始数据/sourcedata.txt");
        //4）创建kafka的生产者实例，将数据写入到kafka集群(无集群
        Properties props = new Properties();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "120.55.78.114:9092");
